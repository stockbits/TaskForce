...
export default function TimelinePanel() {
  ...
  return (
    <Box sx={{ height: "100%", width: "100%", display: "flex", flexDirection: "column", bgcolor: "#fafafa" }}>
      {/* Header */}
      <Box sx={{ display: "flex", height: 40, bgcolor: "white", borderBottom: "1px solid #e0e0e0" }}>
        <Box
          sx={{
            ...
            {timelineIntervals.map((it, i) => (
              <Box
                ...
                sx={{
                  ...
                  fontSize: "0.75rem",
                  color: "#666",
                  borderRight: i < timelineIntervals.length - 1 ? "1px solid #eee" : "none",
                }}
              >
                {it.label}
              </Box>
                ...
                <Box sx={{ position: "absolute", inset: 0, display: "flex", pointerEvents: "none" }}>
                  {timelineIntervals.map((it, i) => (
                    <Box
                      ...
                      sx={{
                        width: PX_PER_HOUR,
                        borderRight: i < timelineIntervals.length - 1 ? "1px solid #f5f5f5" : "none",
                      }}
                    />
                  ))}
                </Box>
